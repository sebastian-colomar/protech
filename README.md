...
This section provides instructions to upgrade an existing **OpenShift 4.8.37 cluster** to a newer supported version. It covers pre-upgrade checks, image source configuration, and the upgrade procedure using the `oc` CLI.
