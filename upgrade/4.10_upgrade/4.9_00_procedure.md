...
# 4. [Updating a cluster in a disconnected environment](4.9_upgrade.md)
# 5. [Upgrade OCS to Red Hat OpenShift Data Foundation (ODF)](4.9_odf.md)
# 6. [Upgrade Elastic Search and Cluster Logging](4.9_logging.md)
