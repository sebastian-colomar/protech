...
3.7. Create the mirrored release image signature ConfigMap manifest:
   ...
   ```
   for release in ${OCP_RELEASE_NEW} ${OCP_RELEASE_OLD}; do
      sed -i 's|"name":"sha256-[a-f0-9]*"|"name":"'${MIRROR_OCP_REPOSITORY}-${release//./-}'"|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OCP_REPOSITORY}-${release}/config/signature-sha256-*.yaml
...
3.11. Upload the catalog images to the local container registry:
   ...
   oc-${OCP_RELEASE_NEW} adm catalog mirror file://${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/${RH_REPOSITORY}/${RH_INDEX}:${RH_INDEX_VERSION_NEW} ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW} --insecure
   ```
   ```
   cd ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}
   oc-${OCP_RELEASE_OLD} adm catalog mirror file://${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/${RH_REPOSITORY}/${RH_INDEX}:${RH_INDEX_VERSION_OLD} ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD} --insecure
   ```
...
3.11. Create the CatalogSource object by running the following command to specify the catalogSource.yaml file in your manifests directory:
   ```
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/manifests-${RH_INDEX}-*/catalogSource.yaml
   oc-${OCP_RELEASE_NEW} apply -f ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/manifests-${RH_INDEX}-*/catalogSource.yaml
   ```
   ```
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/manifests-${RH_INDEX}-*/catalogSource.yaml
   oc-${OCP_RELEASE_OLD} apply -f ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/manifests-${RH_INDEX}-*/catalogSource.yaml
   ```
...
3.12. Create the ImageContentSourcePolicy (ICSP) object by running the following command to specify the imageContentSourcePolicy.yaml file in your manifests directory:
   ```
   oc-${OCP_RELEASE_NEW} adm catalog mirror ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/${RH_REPOSITORY}-${RH_INDEX}:${RH_INDEX_VERSION_NEW} ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW} --insecure --manifests-only
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/manifests-${RH_REPOSITORY}-${RH_INDEX}-*/imageContentSourcePolicy.yaml
   oc-${OCP_RELEASE_NEW} apply -f ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW}/manifests-${RH_REPOSITORY}-${RH_INDEX}-*/imageContentSourcePolicy.yaml
   ```
   ```
   oc-${OCP_RELEASE_OLD} adm catalog mirror ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/${RH_REPOSITORY}-${RH_INDEX}:${RH_INDEX_VERSION_OLD} ${LOCAL_REGISTRY}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD} --insecure --manifests-only
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_NEW//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/manifests-${RH_REPOSITORY}-${RH_INDEX}-*/imageContentSourcePolicy.yaml
   oc-${OCP_RELEASE_OLD} apply -f ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${RH_INDEX_VERSION_OLD}/manifests-${RH_REPOSITORY}-${RH_INDEX}-*/imageContentSourcePolicy.yaml
   ```
