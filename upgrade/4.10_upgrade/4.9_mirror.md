...
3.11. Create the CatalogSource object by running the following command to specify the catalogSource.yaml file in your manifests directory:
   ...
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${release//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${release}/manifests-${RH_INDEX}-*/catalogSource.yaml
...
3.12. Create the ImageContentSourcePolicy (ICSP) object by running the following command to specify the imageContentSourcePolicy.yaml file in your manifests directory:
   ...
   sed -i '/name:/s|name:.*$|name: '${MIRROR_OLM_REPOSITORY}-${release//./-}'|' ${REMOVABLE_MEDIA_PATH}/${MIRROR_OLM_REPOSITORY}-${release}/manifests-${RH_REPOSITORY}-${RH_INDEX}-*/imageContentSourcePolicy.yaml
