...
4. Install the OpenShift CLI by downloading the binary.
   ...
   > If you are upgrading a cluster in a disconnected environment, install the oc version that you plan to upgrade to.
    ...
    source ~/.bashrc
    curl -O https://mirror.openshift.com/pub/openshift-v4/clients/ocp/${OCP_RELEASE}/openshift-client-linux.tar.gz
...
##### Procedure
1. Using the Distribution container image with the HTTP protocol:
    ```
