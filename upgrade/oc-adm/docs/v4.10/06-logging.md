...
1.32. UPDATE the OpenShift Cluster Logging Operator:
    ...
    oc -n openshift-logging patch subscription cluster-logging --type=merge -p '{"spec":{"channel":"stable-5.6","source":"mirror-redhat-operator-index-v4-10","sourceNamespace":"openshift-marketplace"}}'
